...
const MusicHome = (props) => {
    ...
    return (
        <HomeMusic>
            ...
            <SongList songsData={songsData} playSong = { playSong } userPlaylists = { userPlaylists } addSongToPlaylist = { addSongToPlaylist }/>

            <MusicPlayer currentSong = { currentSong } />

            <Playlist userData={userData} createPlaylist = { createPlaylist } userPlaylists = { userPlaylists } playListsSongs = { playListsSongs } getUserPlaylists = { getUserPlaylists } getPlaylistSongs = { getPlaylistSongs } />
